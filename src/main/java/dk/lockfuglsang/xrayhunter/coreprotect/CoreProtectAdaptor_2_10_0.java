...
public class CoreProtectAdaptor_2_10_0 extends AbstractCoreProtectAdaptor implements CoreProtectAdaptor {
    @Override
    ...
    private Object[] getArgs(Statement stmt, List<Material> restrictBlocks, List<Integer> actions, Location location, int time, boolean restrictWorld) {
        ...
        return new Object[]{stmt, null, Collections.emptyList(), Collections.emptyList(), convertMats(restrictBlocks),
