...
public class CoreProtectAdaptor_2_15_0 extends AbstractCoreProtectAdaptor implements CoreProtectAdaptor {
    @Override
    public boolean isAvailable() {
        Plugin plugin = Bukkit.getPluginManager().getPlugin("CoreProtect");
        return plugin != null && plugin.getDescription() != null &&
                isVersionLaterThan(plugin.getDescription().getVersion(), "2.15") &&
